...
import PinImage from "@/app/components/pinpage/PinImage";
import PinInfo from "@/app/components/pinpage/PinInfo";
function PinDetail({params}) {
    ...
    return (
        <>
            {pinDetail?
                <div className=' bg-white p-2 md:p-12 rounded-2xl md:px-24 lg:px-36'>
                    <HiArrowSmallLeft className='text-[60px] font-bold ml-[-5px] md:ml-[-50px]
